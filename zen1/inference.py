...
class Zen1Model:
    ...
    def load_model(self):
        ...
        print(f"Loading Zen1-{self.variant.title()} model...")
...
def interactive_mode(model: Zen1Model):
    ...
    print("\n" + "="*50)
    print(f"Zen1-{model.variant.title()} Interactive Mode")
...
def main():
    parser = argparse.ArgumentParser(description="Zen1 Model Inference")
