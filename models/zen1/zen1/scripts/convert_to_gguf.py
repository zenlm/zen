#!/usr/bin/env python3
"""
Convert Hanzo Zen1 model to GGUF format for Ollama
"""
...
# Create Modelfile
modelfile_content = f"""# Hanzo Zen1 - Fine-tuned on Apple Silicon
...
SYSTEM You are Hanzo Zen1, fine-tuned with knowledge of the Hanzo AI ecosystem including @hanzo/ui components, MCP tools, LLM Gateway, and all Hanzo SDKs.
