...
"""
Zen-1-Thinking Fine-tuning Script
...
class Zen1ThinkingTrainer:
    """Trainer for Zen-1-Thinking model"""
...
def main():
    parser = argparse.ArgumentParser(description="Fine-tune Zen-1-Thinking")
    ...
    if args.eval_only:
        ...
        # Full training
        print("\n" + "="*60)
        print("Starting Zen-1-Thinking Fine-tuning")
