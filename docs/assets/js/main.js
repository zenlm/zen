...
// Observe all model cards and architecture cards
document.querySelectorAll('.model-card, .arch-card, .download-card').forEach(card => {
...
// Add stagger effect to model cards
