...
def create_modelfile_for_qwen3(model_type="thinking"):
    ...
    modelfile = f"""# Hanzo Zen1 based on Qwen3-4B-{model_type.title()}-2507
FROM qwen2.5:3b
...
SYSTEM \"\"\"
You are Hanzo Zen1, fine-tuned from Qwen3-4B-{model_type.title()}-2507 with deep Hanzo ecosystem knowledge.
